...
type GameMode = 'roulette' | 'poker' | 'score';
...
const App: React.FC = () => {
  ...
  useEffect(() => {
    const titles: Record<GameMode, string> = {
      roulette: "Liar's Bar – Deck",
      poker: "Liar's Bar – Poker",
      score: "Liar's Bar – Card Score",
    };
    ...
    <>
      ...
      <div className="mode-content">
        <div key={currentMode} className="mode-content-inner">
          ...
          {currentMode === 'poker' && <PokerGame muted={muted} />}
          {currentMode === 'score' && <ScoreTracking />}
        </div>
      </div>
